...
\abstract{ Studies of the timing performance of a variety of LYSO-based
  calorimeteric detectors are presented, characterizing the
  ...
  time resolution of $30$~ps is achievable. Important applications of precision timing calorimeters
...
In past studies~\cite{MCPFastCaloNIMA}, we measured the time
...
We also measured the electronic time resolution of the DAQ system 
...
of studies focusing additionally on the contributions due to fluctuations
...
Apart from effects of the photodetector and DAQ electronics,
...
as well as the time jitter. We study these effects using
two independent experimental setups. 

For a traditional homogeneous crystal calorimeter, the optical
transit effects are significant as scintillation light must
...
small LYSO cube, with linear dimensions of $1.7\mathrm{cm}$, as the 
...
we measure the time of flight resolution.

Second, we study a shashlik calorimeter composed of alternating layers 
of tungsten and LYSO, with scintillation light signal extracted
through wavelength shifting (WLS) fibers, where optical transit through
the fiber is the dominant factor for timing. Additionally, we
study an alternative version of this calorimeter where
light is extracted through direct optical coupling to the edges of a few
LYSO layers, where optical transit effects are less dominant.
...
Although the thickness of the LYSO active element layer is relatively
...
to about $20$~ps, we infer that the combined contribution to the time 
resolution from the shower profile fluctuations, the scintillation mechanism,
and the optical transit inside the LYSO cube is between $24$~ps and $27$~ps,
depending on the impact of the beam geometry. In future studies, we intend 
...
by WLS fibers through a set of four holes penetrating 
...
optimizing the time resolution for the design of this type of calorimeter, 
and that the DSB1 fiber already provides a reasonably good choice. Furthermore,
...
transit is less than $30$~ps. Studies of the
effect of optical transit through the use of WLS
...
of the wavelength shifting mechanism, we achieve a best time  
resolution of $55$~ps. This result gives some indication that such a
...
with light extraction through the DSB1 fibers and for the 
