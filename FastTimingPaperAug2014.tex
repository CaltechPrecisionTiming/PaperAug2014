...
\begin{figure}[H] \centering
\includegraphics[width=0.6\textwidth]{figs/Shashlik_Design.pdf} 
\caption{ The shashlik configuration based upon interleaved W and LYSO layers. 
Twenty-nine LYSO crystals and twenty-eight W plates comprise the module. 
Four WLS quartz capillaries are used to read out the scintillation light from the 
tiles. } 
