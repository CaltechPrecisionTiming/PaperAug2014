...
\maketitle
\abstract{
We present studies of the timing performance of a variety of
LYSO-based calorimeteric detectors, fully characterizing
the contributions of the dominant factors affecting the
time of flight resolution. For certain types of 
LYSO-based calorimeter designs, we demonstrate that 
a time of flight resolution of $30$~ps is achievable,
in particular limiting the contribution of event-by-event
fluctuations in the scintillation process and optical
transit to less than $20$~ps. Important applications
of such precision timing calorimeters in the context
of detector upgrades for the High Luminosity LHC at
CERN to mitigate the detrimental effects of large pileup
to object and event reconstruction is discussed. 
...
reslution for such an experimental setup. 
...
time measurement is made. Through the comparison of results
...
significantly increases. This effect can be seen in 
...
for organizing and providing supporting equipment at FTBF. We are
grateful to Jason Trevor for design and construction of special supports
for various photodetectors and shashlik calorimeter assembly.
